...
public class Broker extends Thread {
    ...
    public static List<Value> values =Collections.synchronizedList( new ArrayList<>());        //Create the list that all the Brokers will sent the items which they would recieve from the publishers
